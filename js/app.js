...
const $changeToEsp = document.getElementById('ESP');
const $changeToEnd = document.getElementById('ENG');

const $changeText = document.getElementById('presentacion-es');
const $changeContact = document.getElementById('contact');
const $changeSkills = document.getElementById('skills');
const $changeTitleSkills = document.getElementById('Skills');
const $changeWorks = document.getElementById('works');
const $changeTitleWorks = document.getElementById('Works');
const $changeHome = document.getElementById('home');
const $changeCV = document.getElementById('CV');
const $changeTogether = document.getElementById('together');
const $changeContactMe = document.getElementById('contactme');
const $changeNombre = document.getElementById('nombre');
const $changeEmail = document.getElementById('email');
const $changeMensaje = document.getElementById('mensaje');
const $changeSubir = document.getElementById('subir');
const $changeFooter = document.getElementById('footer-text');
