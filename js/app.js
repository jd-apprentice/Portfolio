...
function traducirESP() {
  ...
  $changeFooter.innerHTML = `<p id="footer-text">&copy; Vectores bajados de <a href="https://worldvectorlogo.com/" class="text-primary">worldvectorlogo</a></p>`;
...
function traducirENG() {
  ...
  $changeFooter.innerHTML = `<p id="footer-text">&copy; SVG files from <a href="https://worldvectorlogo.com/" class="text-primary">worldvectorlogo</a></p>`;
